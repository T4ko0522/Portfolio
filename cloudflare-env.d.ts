/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 7592b26cffdb394490829f77273cedd1)
...
interface __BaseEnv_CloudflareEnv {
	...
	SPOTIFY_STATUS_DO: DurableObjectNamespace<import("./worker/index").SpotifyStatusDO>;
	WORKER_SELF_REFERENCE: Service<typeof import("./worker/index").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "SpotifyStatusDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_DISCORD_WEBHOOK_URL" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
