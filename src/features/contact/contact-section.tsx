  ...
  return (
    ...
    >
      ...
      >
        ...
        <button type="button" onClick={onCopyDiscord} className="flex items-baseline gap-3 group">
          <span className="text-[10px] tracking-[0.4em] uppercase text-white/30 font-light">
            Discord
          </span>
          ...
          <span className="text-[10px] tracking-[0.3em] uppercase text-white/20 font-light"></span>
        </button>
      </motion.div>
    </motion.div>
  )
