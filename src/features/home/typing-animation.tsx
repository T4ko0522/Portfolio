...
export default function TypingAnimation({ texts, className = "" }: TypingAnimationProps) {
  ...
  return (
    <div className={`flex items-center justify-center gap-x-2 w-full py-4 ${className}`}>
      <div className="flex items-center gap-x-2 leading-normal" style={{ lineHeight: "1.9" }}>
        ...
        <span className="text-white flex items-center" style={{ minHeight: "1.9em" }}>
          ...
          {/* カーソル（overflow の外に配置） */}
          <span
            className="inline-block w-1 bg-white ml-2 animate-blink flex-shrink-0"
            style={{ height: "1em" }}
          />
        </span>
      </div>
