...
import type { DiscordStatus } from "@/features/presence/types"
    ...
    <div className="w-full flex flex-col items-center gap-1">
      ...
      >
        <div className="relative w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] flex items-center justify-center">
          ...
          {/* アイコン本体 */}
          <motion.div className="w-40 h-40 sm:w-48 sm:h-48 rounded-full overflow-visible relative z-40">
      ...
      >
        <Card className="bg-transparent border-transparent">
          <CardContent className="p-4 sm:p-6">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-6 text-cyan-300">
              💻 About Me
            </h3>
            ...
            <p className="mb-4 sm:mb-6 text-white text-sm sm:text-base">
              ...
              <span className="block text-xs sm:text-sm italic text-gray-200 mt-2">
                ...
                <br />
                Currently studying web development and is a full-stack engineer capable of both
